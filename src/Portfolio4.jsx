...
<li className="text-white" data-aos="zoom-in">
<strong>Project date</strong> : 12, April 2024
</li>
<li className="text-white" data-aos="zoom-in">
<strong>Project Name</strong> : ABC-Cinema Website
</li><br/>
<li className="text-white" data-aos="zoom-in">
<strong>Project Details</strong> :
</li>
<p className="text-white" data-aos="zoom-in">
    This Project name is ABC - Cinema Webpage.This Project is live on Github.
