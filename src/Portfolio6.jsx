...
<li className="text-white" data-aos="zoom-in">
<strong>Project date</strong> : 25, February 2024
</li>
<li className="text-white" data-aos="zoom-in">
<strong>Project Name</strong> : Medical Manufacturing Website
</li><br/>
<li className="text-white" data-aos="zoom-in">
<strong>Project Details</strong> :
</li>
<p className="text-white" data-aos="zoom-in">
    This Project name is Medical Manufacturing Webpage.This Project is live on Github.
